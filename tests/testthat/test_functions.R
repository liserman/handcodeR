...
test_that("Test 1 character_to_data", {
  ...
  output <- character_to_data(data = data, arg_list = arg_list, missing = missing)
...
test_that("Test 2 character_to_data", {
  ...
  output <- character_to_data(data = data, comparison = comparison, arg_list = arg_list, missing = missing)
...
test_that("Test 1 data_for_app", {
  ...
  # Names
  expect_equal(names(a), c("container", "data_app", "start_app", "classifications", "context_app", "compare"))
