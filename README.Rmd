...
```{R, echo = FALSE, width = 2000}
  ...
  container <- data.frame(var1 = data[,2])
...
shiny::observeEvent(input$previouspage, {
      ...
      shiny::updateRadioButtons(session, "code1", selected = "")
})
...
After finishing the classification process, the function returns a dataframe.
