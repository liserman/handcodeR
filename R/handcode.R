...
#'
#' @param a List; contains all information required for the app to function. This list is automatically generated by `data_for_app`.
#'
...
#' @param names Logical; if TRUE, the function returns a formatted list of labels; if FALSE, it returns a vector of names suitable for `radioButtons`.
#' @return A list of HTML-formatted labels or a vector of category names for `radioButtons` in the Shiny app, depending on the value of the `names` parameter.
