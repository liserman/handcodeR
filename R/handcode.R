...
#'
#' @param a A list containing all relevant information for the app to function. The list will be automatically generated by `handcode`.
#'
...
handcode <- function(data, ... , start = "first_empty", randomize = FALSE, context = FALSE) {
  ...
  if (system.file(package="shiny") == "") stop("handcode() requires the package shiny to be installed. You can run install.packages(\"shiny\") to install shiny.")
