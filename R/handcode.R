...
#' @return The shinyApp returns a dataframe with the coded variables.
...
#' @return The function returns a dataframe with the coded variables.
...
#' @return The function returns a dataframe in the format of the output dataframe that can be processed by the handcode() function.
...
# Checks and datahandling for data input ----------------------------------
  ...
  # Check if data is either dataframe or character vector of texts
  ...
  if(is.character(data)){
    ...
    if(any(sapply(arg_list, function(x) "" %in% x))) stop("The default missing value \"\" cannot be part of the categories of any variable you want to code with handcode()." )
    ...
    if(any(sapply(arg_list, function(x) missing %in% x))) stop("Values given as categories in variables you want to code with handcode() cannot be similar to values you give in missing.")
